...
export default function NeighborhoodModal() {
  ...
  const neighbors = useNeighborhoodStore((s) => s.neighbors)
  const neighborhoodLevel = useNeighborhoodStore((s) => s.neighborhoodLevel)
  const setNeighborhoodLevel = useNeighborhoodStore(
    (s) => s.setNeighborhoodLevel
  )
  const clearNeighborhood = useNeighborhoodStore((s) => s.clearNeighborhood)
